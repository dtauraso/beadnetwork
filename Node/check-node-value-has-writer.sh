...
# PLACEMENT: Node/node_values.go | a declared node value must be written by WriteNodeValues, or it crosses as an empty section and the renderer silently reads its fallback
