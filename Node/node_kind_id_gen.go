...
// Source: NodeKinds/<Kind>/SPEC.md + bead.Register calls.
...
// assigned once per kind in NodeKinds/<Kind>/SPEC.md and never renumbered by sort
...
// and assigned once (see NodeKinds/<Kind>/SPEC.md kindId), so — unlike the id
...
// and the description, both authored in NodeKinds/<Kind>/SPEC.md alongside the id.
