...
# PLACEMENT: Input/Stdin/edit_update_decode.go,*/edit_decode.go,Scene/scenerun/dispatch_edit.go | a new addressed-edit attribute must reach a handler, not just decode off the wire
