...
# PLACEMENT: Scene/scenerun/move_dispatch_api.go,Node/nodeactor/node_geometry.go | a composer struct (MoveDispatch, nodeactor.NodeGeometry) stays THIN: new state belongs in a named sub-struct, not a new loose field
...
COMPOSERS=(
  ...
  "type NodeGeometry struct {|22|the responsible owner type (owners.Messaging/Clocks/Stream/UI/Tilt/Readout/Outs/Topology/Flags/Beads/Deltas/ChannelVectors, Node/nodeactor/owners/)"
)
