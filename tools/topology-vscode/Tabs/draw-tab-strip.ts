...
import {
  COL_STREAM_TAB_STRIP_STRIP_X, COL_STREAM_TAB_STRIP_STRIP_Y,
  COL_STREAM_TAB_STRIP_STRIP_W, COL_STREAM_TAB_STRIP_STRIP_H,
  COL_STREAM_TAB_STRIP_TAB_X, COL_STREAM_TAB_STRIP_TAB_Y,
  COL_STREAM_TAB_STRIP_TAB_W, COL_STREAM_TAB_STRIP_TAB_H,
  COL_STREAM_TAB_STRIP_TAB_NAME_TEXT, COL_STREAM_TAB_STRIP_TAB_NAME_LEN,
  COL_STREAM_TAB_STRIP_TAB_SELECTED,
