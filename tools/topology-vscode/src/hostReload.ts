...
// out: this is single-actor decision logic (a hash comparison, a settings read), not two
// goroutines/processes communicating — extension.ts itself is wiring that cannot be driven
// headlessly (it needs a live vscode.ExtensionContext and a real reload command).
