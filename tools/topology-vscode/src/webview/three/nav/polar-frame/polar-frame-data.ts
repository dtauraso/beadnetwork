...
// Every arc is a QUARTER, and each is named by the angle it REACHES — one
// number, in multiples of pi, on the same scale the axis labels use ("+Z
// phi-pi/2"). Naming the interval instead would take two numbers to say the
// same thing, since every arc is pi/2 wide and the far end fixes the near one.
//
// The two theta meridians cover the same theta twice over, so each name also
// carries the phi of the meridian it lies on — a different quantity, one
// number of its own.
export const THETA_CIRCLES: { sx: number; sy: number; n: number; c: string; label: string }[] = [
  { sx: 1, sy: 1, n: 2, c: "#ff8c00", label: "θ π/2 φ0" },
  { sx: 1, sy: -1, n: 4, c: "#9370db", label: "θ π φ0" },
  { sx: -1, sy: 1, n: 6, c: "#9acd32", label: "θ π/2 φπ" },
  { sx: -1, sy: -1, n: 8, c: "#cd853f", label: "θ π φπ" },
];
...
export const THETA_CIRCLES_PHI_HALF: { sy: number; sz: number; n: number; c: string; label: string }[] = [
  { sy: 1, sz: 1, n: 21, c: "#9acd32", label: "θ π/2 φπ/2" },
  { sy: 1, sz: -1, n: 22, c: "#9acd32", label: "θ π/2 φ3π/2" },
  { sy: -1, sz: 1, n: 23, c: "#00ced1", label: "θ π φπ/2" },
  { sy: -1, sz: -1, n: 24, c: "#9370db", label: "θ π φ3π/2" },
];
...
export const PHI_CIRCLES: { sx: number; sz: number; n: number; c: string; label: string }[] = [
  { sx: 1, sz: 1, n: 11, c: "#00ced1", label: "φ π/2" },
  { sx: 1, sz: -1, n: 12, c: "#9370db", label: "φ 2π" },
  { sx: -1, sz: 1, n: 13, c: "#ff69b4", label: "φ π" },
  { sx: -1, sz: -1, n: 14, c: "#9acd32", label: "φ 3π/2" },
];
