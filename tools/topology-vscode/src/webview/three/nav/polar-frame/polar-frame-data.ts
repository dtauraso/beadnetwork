...
export const THETA_CIRCLES: { sx: number; sy: number; n: number; c: string; label: string }[] = [
  { sx: 1, sy: 1, n: 2, c: "#ff8c00", label: "θ π/2" },
  { sx: 1, sy: -1, n: 4, c: "#9370db", label: "θ π" },
  { sx: -1, sy: 1, n: 6, c: "#9acd32", label: "θ π/2 φ π" },
  { sx: -1, sy: -1, n: 8, c: "#cd853f", label: "θ π φ π" },
];
...
export const THETA_CIRCLES_PHI_HALF: { sy: number; sz: number; n: number; c: string; label: string }[] = [
  { sy: 1, sz: 1, n: 21, c: "#9acd32", label: "θ π/2 φ π/2" },
  { sy: 1, sz: -1, n: 22, c: "#9acd32", label: "θ π/2 φ 3π/2" },
  { sy: -1, sz: 1, n: 23, c: "#00ced1", label: "θ π φ π/2" },
  { sy: -1, sz: -1, n: 24, c: "#9370db", label: "θ π φ 3π/2" },
];
...
export const PHI_CIRCLES: { sx: number; sz: number; n: number; c: string; label: string }[] = [
  { sx: 1, sz: 1, n: 11, c: "#00ced1", label: "θ π/2 φ π/2" },
  { sx: 1, sz: -1, n: 12, c: "#9370db", label: "θ π/2 φ 2π" },
  { sx: -1, sz: 1, n: 13, c: "#ff69b4", label: "θ π/2 φ π" },
  { sx: -1, sz: -1, n: 14, c: "#9acd32", label: "θ π/2 φ 3π/2" },
];
