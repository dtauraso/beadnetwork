 ...
 *  This is the TS→Go binary buffer, symmetric with the per-goroutine content-buffer
 *  streams. No await, no response, no delivery signal (CLAUDE.md "TS → Go send is
 *  **fire-and-forget**"). */
