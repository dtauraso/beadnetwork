...
import {
  COL_STREAM_RULES_PANEL_MENU_ANCHOR_ROW,
  COL_STREAM_RULES_PANEL_MENU_X, COL_STREAM_RULES_PANEL_MENU_Y,
  COL_STREAM_RULES_PANEL_MENU_W, COL_STREAM_RULES_PANEL_MENU_H,
  COL_STREAM_RULES_PANEL_MENU_ROW_X, COL_STREAM_RULES_PANEL_MENU_ROW_Y,
  COL_STREAM_RULES_PANEL_MENU_ROW_W, COL_STREAM_RULES_PANEL_MENU_ROW_H,
  COL_STREAM_RULES_PANEL_MENU_CHECK_X, COL_STREAM_RULES_PANEL_MENU_CHECK_Y,
  COL_STREAM_RULES_PANEL_MENU_LABEL_DATA, COL_STREAM_RULES_PANEL_MENU_LABEL_LEN,
  COL_STREAM_RULES_PANEL_MENU_NODE_ROW,
