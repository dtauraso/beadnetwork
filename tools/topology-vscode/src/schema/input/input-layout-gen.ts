...
export const IN_UPDATE_KINDS = ["overlays", "clock", "removed-distanceGroup", "scene", "tiltVector", "panels", "node", "edge"] as const;
// EDIT_UPDATE_KINDS_END
export const IN_UPDATE_ATTRS = ["toggle", "speed", "removed-length", "selected", "phi", "reset", "start", "latticePoints", "create", "delete", "dragPhi", "dragMaxTheta", "dragActive", "kindActive", "selfDragPhi", "selfDragMaxTheta", "selfDragActive", "dragR", "selfDragR"] as const;
