...
export const IN_UPDATE_ATTRS = ["toggle", "speed", "length", "selected", "phi", "reset", "start", "latticePoints", "create", "delete", "dragPhi", "dragMaxTheta", "dragActive", "kindActive", "selfDragPhi", "selfDragMaxTheta", "selfDragActive", "dragR", "selfDragR"] as const;
