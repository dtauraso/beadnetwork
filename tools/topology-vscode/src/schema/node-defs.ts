...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  PulseLeft: { bg: "#e1f5fe", border: "#00bcd4", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#00bcd4", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  PulseRight: { bg: "#e1f5fe", border: "#3949ab", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#3949ab", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  ...
  TimeEnd: { bg: "#fff3e0", border: "#d50000", text: "#bf360c", minWidth: 60, shape: "rect", fill: "#fff3e0", stroke: "#d50000", width: 60, height: 60, inputs: [{ name: "In", kind: "chain" }] },
...
export const NODE_DEFS_ARRAY: readonly NodeDef[] = [
  { bg: "#fff3e0", border: "#d50000", text: "#bf360c", minWidth: 60, shape: "rect", fill: "#fff3e0", stroke: "#d50000", width: 60, height: 60, inputs: [{ name: "In", kind: "chain" }] },
  ...
  { bg: "#fce4ec", border: "#880e4f", text: "#880e4f", minWidth: 110, shape: "rect", fill: "#fce4ec", stroke: "#880e4f", width: 80, height: 60, inputs: [{ name: "FromLeft", kind: "chain" }, { name: "FromRight", kind: "chain" }], outputs: [{ name: "ToPassed", kind: "chain" }] },
  { bg: "#e1f5fe", border: "#00bcd4", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#00bcd4", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  { bg: "#e1f5fe", border: "#3949ab", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#3949ab", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
