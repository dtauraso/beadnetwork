...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  PulseLeft: { bg: "#e1f5fe", border: "#40c4ff", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#40c4ff", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  PulseRight: { bg: "#e1f5fe", border: "#002171", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#002171", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
...
export const NODE_DEFS_ARRAY: readonly NodeDef[] = [
  ...
  { bg: "#e1f5fe", border: "#40c4ff", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#40c4ff", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  { bg: "#e1f5fe", border: "#002171", text: "#01579b", minWidth: 90, shape: "rect", fill: "#e1f5fe", stroke: "#002171", width: 90, height: 60, inputs: [{ name: "FromInput", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }, { name: "Out2", kind: "chain" }] },
  { bg: "#fff3e0", border: "#ffc400", text: "#bf360c", minWidth: 90, shape: "rect", fill: "#fff3e0", stroke: "#ffc400", width: 90, height: 60, inputs: [{ name: "FromPrevTimeNode", kind: "chain" }], outputs: [{ name: "ToNext", kind: "chain", isMulti: true }] },
];
