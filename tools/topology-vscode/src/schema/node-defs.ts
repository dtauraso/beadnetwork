...
export const NODE_DEFS: Record<string, NodeDef> = {
  ...
  Node2: { bg: "#e8eaf6", border: "#3949ab", text: "#1a237e", minWidth: 70, shape: "rect", fill: "#e8eaf6", stroke: "#3949ab", width: 70, height: 60, inputs: [{ name: "In", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }] },
...
export const NODE_DEFS_ARRAY: readonly NodeDef[] = [
  ...
  { bg: "#e8eaf6", border: "#3949ab", text: "#1a237e", minWidth: 70, shape: "rect", fill: "#e8eaf6", stroke: "#3949ab", width: 70, height: 60, inputs: [{ name: "In", kind: "chain" }], outputs: [{ name: "Out", kind: "chain" }] },
];
