...
export const NODE_COL_VECTOR_LEN                 = 64; // f32
export const NODE_COL_VECTOR_THETA               = 68; // f32
export const NODE_COL_VECTOR_PHI                 = 72; // f32
...
export function readNodeVectorLen(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_VECTOR_LEN, true); }
export function readNodeVectorTheta(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_VECTOR_THETA, true); }
export function readNodeVectorPhi(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_VECTOR_PHI, true); }
