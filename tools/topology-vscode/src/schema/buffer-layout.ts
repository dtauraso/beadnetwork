...
export const EDGE_COL_LEN                        = 17; // f32
export const EDGE_COL_GROUP_IDX                  = 21; // i32
export const EDGE_STRIDE                         = 25;
...
export function readEdgeLen(view: DataView, row: number): number { return view.getFloat32(row * EDGE_STRIDE + EDGE_COL_LEN, true); }
export function readEdgeGroupIdx(view: DataView, row: number): number { return view.getInt32(row * EDGE_STRIDE + EDGE_COL_GROUP_IDX, true); }
