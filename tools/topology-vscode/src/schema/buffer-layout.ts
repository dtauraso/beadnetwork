...
export const NODE_COL_TILT_VECTOR_LEN            = 64; // f32
export const NODE_COL_TILT_VECTOR_THETA          = 68; // f32
export const NODE_COL_TILT_VECTOR_PHI            = 72; // f32
export const NODE_COL_VECTOR2THETA               = 76; // f32
export const NODE_COL_VECTOR2PHI                 = 80; // f32
export const NODE_COL_SELECTED                   = 84; // u8
export const NODE_COL_KIND_ID                    = 85; // u8
export const NODE_COL_LABEL_OFF                  = 86; // u32
export const NODE_COL_LABEL_LEN                  = 90; // u32
export const NODE_COL_HOVERED                    = 94; // u8
export const NODE_COL_LATCHED_SEL                = 95; // u8
export const NODE_STRIDE                         = 96;
...
export function readNodeTiltVectorLen(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_TILT_VECTOR_LEN, true); }
export function readNodeTiltVectorTheta(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_TILT_VECTOR_THETA, true); }
export function readNodeTiltVectorPhi(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_TILT_VECTOR_PHI, true); }
export function readNodeVector2Theta(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_VECTOR2THETA, true); }
export function readNodeVector2Phi(view: DataView, row: number): number { return view.getFloat32(row * NODE_STRIDE + NODE_COL_VECTOR2PHI, true); }
