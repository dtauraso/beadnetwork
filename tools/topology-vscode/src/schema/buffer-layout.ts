...
export const BUF_LAYOUT_VERSION = 36;
...
export const CHAIN_BEAD_COL_RADIUS               = 17; // f32
export const CHAIN_BEAD_STRIDE                   = 21;
...
export function readChainBeadRadius(view: DataView, row: number): number { return view.getFloat32(row * CHAIN_BEAD_STRIDE + CHAIN_BEAD_COL_RADIUS, true); }
