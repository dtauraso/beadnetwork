...
export const CHAIN_BEAD_COL_TWEEN                = 17; // u8
export const CHAIN_BEAD_STRIDE                   = 18;
...
export function readChainBeadTween(view: DataView, row: number): number { return view.getUint8(row * CHAIN_BEAD_STRIDE + CHAIN_BEAD_COL_TWEEN); }
...
export const OVERLAY_COL_POLAR_VECTORS           = 8; // u8
export const OVERLAY_COL_BEAD_TWEENS             = 9; // u8
export const OVERLAY_COL_DRAG_NODE_ROW           = 10; // i32
export const OVERLAY_COL_GROUP_LEN_TIME          = 14; // f32
export const OVERLAY_COL_GROUP_LEN_INPUT         = 18; // f32
export const OVERLAY_COL_GROUP_LEN_GATE          = 22; // f32
export const OVERLAY_STRIDE                      = 26;
...
export function readOverlayPolarVectors(view: DataView): number { return view.getUint8(OVERLAY_COL_POLAR_VECTORS); }
export function readOverlayBeadTweens(view: DataView): number { return view.getUint8(OVERLAY_COL_BEAD_TWEENS); }
