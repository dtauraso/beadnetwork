...
export const NODE_COL_BOTTOM_TILT_VECTOR_THETA   = 76; // f32
export const NODE_COL_BOTTOM_TILT_VECTOR_PHI     = 80; // f32
export const NODE_COL_COPLANAR_NORMAL_THETA      = 84; // f32
export const NODE_COL_COPLANAR_NORMAL_PHI        = 88; // f32
export const NODE_COL_RECEIVED_VECTOR_LEN        = 92; // f32
export const NODE_COL_RECEIVED_VECTOR_THETA      = 96; // f32
export const NODE_COL_RECEIVED_VECTOR_PHI        = 100; // f32
export const NODE_COL_SELECTED                   = 104; // u8
export const NODE_COL_KIND_ID                    = 105; // u8
export const NODE_COL_LABEL_OFF                  = 106; // u32
export const NODE_COL_LABEL_LEN                  = 110; // u32
export const NODE_COL_HOVERED                    = 114; // u8
export const NODE_COL_LATCHED_SEL                = 115; // u8
export const NODE_STRIDE                         = 116;
...
export const OVERLAY_COL_SPEED                   = 23; // f32
export const OVERLAY_STRIDE                      = 27;
