...
export const PANEL_FONT = "ui-sans-serif, system-ui, sans-serif";

export function panelFont(px: number, weight?: number | "bold"): string {
  return `${weight ? `${weight} ` : ""}${px}px ${PANEL_FONT}`;
}
