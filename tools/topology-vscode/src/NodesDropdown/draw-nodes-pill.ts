...
import {
  COL_STREAM_NODES_PILL_PILL_X, COL_STREAM_NODES_PILL_PILL_Y,
  COL_STREAM_NODES_PILL_PILL_W, COL_STREAM_NODES_PILL_PILL_H,
  COL_STREAM_NODES_PILL_OPEN,
  COL_STREAM_NODES_PILL_POPOVER_X, COL_STREAM_NODES_PILL_POPOVER_Y,
  COL_STREAM_NODES_PILL_POPOVER_W, COL_STREAM_NODES_PILL_POPOVER_H,
  COL_STREAM_NODES_PILL_LABEL_TEXT,
  COL_STREAM_NODES_PILL_ROW_X, COL_STREAM_NODES_PILL_ROW_Y,
  COL_STREAM_NODES_PILL_ROW_W, COL_STREAM_NODES_PILL_ROW_H,
  COL_STREAM_NODES_PILL_ROW_OPEN,
  ...
  COL_STREAM_NODES_PILL_DESC_X, COL_STREAM_NODES_PILL_DESC_Y,
  COL_STREAM_NODES_PILL_DESC_W, COL_STREAM_NODES_PILL_DESC_H,
  COL_STREAM_NODES_PILL_REFUSED_COUNT,
