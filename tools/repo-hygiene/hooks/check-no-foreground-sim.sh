...
emit deny "Foreground sim run blocked (memory/feedback/process/guardrails/feedback_no_foreground_sim_runs.md): the sim can fail to exit and will hang the Bash call. Re-run backgrounded (run_in_background=true), or wrap it: tools/run-bounded.sh <seconds> <cmd…>."
exit 0
