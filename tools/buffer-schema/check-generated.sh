...
# PLACEMENT: tools/topology-vscode/**/buffer_block.go,tools/topology-vscode/Buffer/bufschema/layout*.go,nodes/Wiring/inputcodec/input_fingerprint.go,nodes/*/SPEC.md | changing a generator source means running `go run ./tools/gen-node-defs` in the SAME commit
set -euo pipefail
