// The emit half of the wire-defs.ts pipeline: writeWireDefs turns the wireProp slice parsed
// by wire_defs.go into WIRE_PROPS/WireProps.
package main
...
func writeWireDefs(outPath string, props []wireProp) error {
	...
	fmt.Fprintln(w, `// GENERATED by: go run ./tools/gen-node-defs (regenerate after editing wire:"..." tags in nodes/Wiring/loadspec/topo_spec.go)`)
	fmt.Fprintln(w, `// Source: nodes/Wiring/loadspec/topo_spec.go wire:"prop,..." tags. Do not edit by hand.`)
	fmt.Fprintln(w)
