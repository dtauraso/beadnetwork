...
# Sourced by tools/bridge/check-message-kind-parity.sh. Each function compares two of the
# extracted kind sets and prints a divergence report, bumping the caller's global $HITS.
