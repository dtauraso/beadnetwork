...
# PLACEMENT: main.go,runtopology/edge_stream.go,runtopology/node_stream.go,src/Buffer/streamframe/stream_fds.go | every conditionally-wired per-owner StreamKind must have a named stream-fd mismatch report
