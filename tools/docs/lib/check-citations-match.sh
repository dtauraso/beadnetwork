...
# Sourced by tools/docs/check-doc-citations.sh. Checks every citation in $TMP/cites.txt
# against the normalized doc blob it claims to quote, reporting each mismatch. Prints
# "clean" and returns 0 on success; prints the report and returns 1 otherwise.
