...
# code comments. Run from repo root: bash tools/docs/check-comment-vocab.sh
#
...
# is rejected at parse — see tools/network/concurrency/check-no-fan-in.sh and topo_spec.go validateNoFanIn). The
