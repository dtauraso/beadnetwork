#!/usr/bin/env bash
#
# PLACEMENT: Buffer/layout.go,nodes/Wiring/input_fingerprint.go,nodes/*/SPEC.md | changing a generator source means running `go run ./tools/gen-node-defs` in the SAME commit
set -euo pipefail
