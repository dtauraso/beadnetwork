...
tools/topology-vscode/src/schema/buffer-layout/buffer-layout.ts -- if that moves and
...
def strides(repo_root):
    path = os.path.join(
        repo_root, "tools/topology-vscode/src/schema/buffer-layout/buffer-layout.ts"
    )
