...
\begin{bmatrix} \text{acute}_{p_1\,\varphi} \\ \text{acute}_{p_1\,\theta} \end{bmatrix}
  &=& \begin{bmatrix} -1 & \text{if } \Delta_{p_1\,\varphi} < \tau_{\varphi}/4 \\[3pt]
                      ...
                      0 & \text{otherwise} \end{bmatrix} \\[10pt]
\begin{bmatrix} \text{center_delta}_{\varphi} \end{bmatrix}
  &=& \begin{bmatrix} \text{zero}_{p_0\,\varphi} \\[3pt]
                      \text{zero}_{p_1\,\varphi} \\[3pt]
                      \text{acute}_{p_0\,\varphi} \\[3pt]
                      \text{acute}_{p_1\,\varphi} \end{bmatrix} \\[10pt]
\begin{bmatrix} \text{center_delta}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix} \text{zero}_{p_0\,\theta} \\[3pt]
                      \text{zero}_{p_1\,\theta} \\[3pt]
                      \text{acute}_{p_0\,\theta} \\[3pt]
                      \text{acute}_{p_1\,\theta} \end{bmatrix} \\[10pt]
