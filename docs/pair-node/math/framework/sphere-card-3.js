...
\begin{bmatrix} \text{acute}^{2}_{p_1\,\varphi} \\ \text{acute}^{2}_{p_1\,\theta} \end{bmatrix}
  &=& \begin{bmatrix} \text{distance}^{2}_{p_1\,\varphi} & \text{if } \text{distance}^{2}_{p_1\,\varphi} < \tau_{\varphi}/4 \\[3pt]
                      ...
                      0 & \text{otherwise} \end{bmatrix} \\[10pt]
\begin{bmatrix} p_{\text{acute}^{0}_{\varphi}} \\ p_{\text{acute}^{0}_{\theta}} \end{bmatrix}
...
\begin{bmatrix} p_{\text{acute}^{1}_{\varphi}} \\ p_{\text{acute}^{1}_{\theta}} \end{bmatrix}
...
\begin{bmatrix} \text{offset}_{\varphi} \\ \text{offset}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix} p_{\text{acute}^{0}_{\varphi}} + p_{\text{acute}^{1}_{\varphi}} \\[6pt]
                      p_{\text{acute}^{0}_{\theta}} + p_{\text{acute}^{1}_{\theta}} \end{bmatrix} \\[10pt]
\begin{bmatrix} \text{offset}_{\varphi} \\ \text{offset}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix}
