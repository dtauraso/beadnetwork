...
\begin{bmatrix} \text{acute}^{2}_{p_1\,\varphi} \\ \text{acute}^{2}_{p_1\,\theta} \end{bmatrix}
  &=& \begin{bmatrix} \text{distance}^{2}_{p_1\,\varphi} & \text{if } \text{distance}^{2}_{p_1\,\varphi} < \tau_{\varphi}/4 \\[3pt]
                      ...
                      0 & \text{otherwise} \end{bmatrix} \\[10pt]
\begin{bmatrix} \text{p\_acute}_{0\,\varphi} \\ \text{p\_acute}_{0\,\theta} \end{bmatrix}
...
\begin{bmatrix} \text{p\_acute}_{1\,\varphi} \\ \text{p\_acute}_{1\,\theta} \end{bmatrix}
...
\begin{bmatrix} \text{offset}_{\varphi} \\ \text{offset}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix} \text{p\_acute}_{0\,\varphi} + \text{p\_acute}_{1\,\varphi} \\[6pt]
                      \text{p\_acute}_{0\,\theta} + \text{p\_acute}_{1\,\theta} \end{bmatrix} \\[10pt]
\begin{bmatrix} \text{offset}_{\varphi} \\ \text{offset}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix}
