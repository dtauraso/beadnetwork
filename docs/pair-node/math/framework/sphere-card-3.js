...
\begin{bmatrix} \text{acute_merge}_{\varphi} \\ \text{acute_merge}_{\theta} \end{bmatrix}
  &=& \begin{bmatrix} -1 & \begin{array}{@{}l@{}} \text{if } \Delta^{1}_{p_0\,\varphi} = 0 \\ \text{or } \Delta^{2}_{p_0\,\varphi} = 0 \end{array} \\[8pt]
                      0 & \text{otherwise} \\[10pt]
                      -1 & \begin{array}{@{}l@{}} \text{if } \Delta^{1}_{p_0\,\theta} = 0 \\ \text{or } \Delta^{2}_{p_0\,\theta} = 0 \end{array} \\[8pt]
                      0 & \text{otherwise} \end{bmatrix} \\[10pt]
