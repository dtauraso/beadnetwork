...
\begin{bmatrix} \text{acute}^{1}_{\text{top}_{\varphi}} \\ \text{acute}^{1}_{\text{top}_{\theta}} \end{bmatrix}
  &\mkern-6mu=& \begin{bmatrix} \text{distance}^{1}_{\text{top}_{\varphi}} & \text{if } \text{distance}^{1}_{\text{top}_{\varphi}} < \tau_{\varphi}/4 \\[3pt]
                      0 & \text{otherwise} \\[6pt]
...
\begin{bmatrix} \text{acute}^{1}_{\text{bottom}_{\varphi}} \\ \text{acute}^{1}_{\text{bottom}_{\theta}} \end{bmatrix}
  &\mkern-6mu=& \begin{bmatrix} \text{distance}^{1}_{\text{bottom}_{\varphi}} & \text{if } \text{distance}^{1}_{\text{bottom}_{\varphi}} < \tau_{\varphi}/4 \\[3pt]
                      0 & \text{otherwise} \\[6pt]
...
\begin{bmatrix} \text{acute}^{2}_{\text{top}_{\varphi}} \\ \text{acute}^{2}_{\text{top}_{\theta}} \end{bmatrix}
  &\mkern-6mu=& \begin{bmatrix} \text{distance}^{2}_{\text{top}_{\varphi}} & \text{if } \text{distance}^{2}_{\text{top}_{\varphi}} < \tau_{\varphi}/4 \\[3pt]
                      0 & \text{otherwise} \\[6pt]
...
\begin{bmatrix} \text{acute}^{2}_{\text{bottom}_{\varphi}} \\ \text{acute}^{2}_{\text{bottom}_{\theta}} \end{bmatrix}
  &\mkern-6mu=& \begin{bmatrix} \text{distance}^{2}_{\text{bottom}_{\varphi}} & \text{if } \text{distance}^{2}_{\text{bottom}_{\varphi}} < \tau_{\varphi}/4 \\[3pt]
                      0 & \text{otherwise} \\[6pt]
