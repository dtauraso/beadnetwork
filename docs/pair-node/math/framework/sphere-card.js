...
const SPHERE_CARD_NOTES = [
  ['note', 'Drag to turn, shift-drag to pan, scroll to zoom. Press 1 or 2 to turn about that sphere’s centre; double-click puts it all back. What faces away is dimmed, not hidden.'],
