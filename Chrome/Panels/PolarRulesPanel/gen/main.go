...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Panels/PolarRulesPanel/gen from PanelValueNames in\n")
	...
	b.WriteString("// learns where from Chrome/Panels/PolarRulesPanel/paths/, which Go writes\n")
