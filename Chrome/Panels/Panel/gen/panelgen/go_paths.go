...
func writeGoPaths(panelDir string, flags []string) error {
	...
	fmt.Fprintln(&buf, `// GENERATED by Chrome/Panels/Panel/gen — do not edit.`)
	fmt.Fprintln(&buf, `// Source: Chrome/Panels/Panel/flags.ts.`)
	...
	fmt.Fprintln(&buf, `// is a u32 length then that many bytes. Chrome/Panels/Panel/paths/block.bin`)
