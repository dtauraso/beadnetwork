...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Panels/SliderPanel/gen from PanelValueNames in\n")
	...
	b.WriteString("// learns where that block is from Chrome/Panels/SliderPanel/paths/, which Go\n")
