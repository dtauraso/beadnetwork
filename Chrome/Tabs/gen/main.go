...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Tabs/gen from StripValueNames in strip_values.go —\n")
	b.WriteString("// do not edit.\n")
	b.WriteString("//\n")
	b.WriteString("// The tab strip's values, each one file under the scene root. The renderer learns\n")
	b.WriteString("// where from Chrome/Tabs/paths/, which Go writes from this same list, so\n")
