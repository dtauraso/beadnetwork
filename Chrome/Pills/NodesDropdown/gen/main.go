...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Pills/NodesDropdown/gen from PillValueNames in\n")
	...
	b.WriteString("// learns where from Chrome/Pills/NodesDropdown/paths/, which Go writes from\n")
