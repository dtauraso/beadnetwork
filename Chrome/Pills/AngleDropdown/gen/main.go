...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Pills/AngleDropdown/gen from PillValueNames in\n")
	...
	b.WriteString("// learns where from Chrome/Pills/AngleDropdown/paths/, which Go writes from\n")
