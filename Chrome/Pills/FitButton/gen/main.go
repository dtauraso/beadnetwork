...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Chrome/Pills/FitButton/gen from ChipValueNames in\n")
	...
	b.WriteString("// where from Chrome/Pills/FitButton/paths/, which Go writes from this same\n")
