...
# PLACEMENT: Overlay/flags.ts,Chrome/Panels/Panel/flags.ts,Input/gen/input_layout_declared.go | the overlay/panel flag REGISTRY and the wire ordering in INPUT_LAYOUT_FINGERPRINT must list the same flags in the same order
...
REGISTRY = {
    "OVERLAY_FLAGS": "Overlay/flags.ts",
    "PANEL_FLAGS": "Chrome/Panels/Panel/flags.ts",
}
FINGERPRINT = "Input/gen/input_layout_declared.go"
