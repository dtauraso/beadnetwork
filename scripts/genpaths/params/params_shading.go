...
import (
	...
	"github.com/dtauraso/wirefold/scripts/genpaths/constexpr"
)
...
func WriteShadingParams(outPath string, params []shadingParam, genName, srcRel string) error {
	var buf bytes.Buffer
	w := bufio.NewWriter(&buf)

	fmt.Fprintf(w, "// GENERATED by %s — do not edit.\n", genName)
	fmt.Fprintf(w, "// Source: %s ShadingParam* constants.\n", srcRel)
