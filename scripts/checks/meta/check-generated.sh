...
# PLACEMENT: **/*_values.go,**/update_attrs.go,Categories/Input/Stdin/record_kinds.go,Categories/Input/Drag/kinds.go,Categories/NodeKinds/*/SPEC.md | changing a generator source means running `go generate ./...` in the SAME commit
set -euo pipefail
