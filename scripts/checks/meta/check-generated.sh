...
# PLACEMENT: **/*_values.go,Categories/Input/gen/input_layout_declared.go,Categories/NodeKinds/*/SPEC.md | changing a generator source means running `go generate ./...` in the SAME commit
set -euo pipefail
