...
`src/Node/bead_run.go`, `src/Node/Wiring/build/loader.go`,
...
A `panic` in `src/Node/`, `src/schema/buffer-layout/`, or `src/schema/buffer-layout/` is an **assertion**, not error handling. It
