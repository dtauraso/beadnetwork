...
var kindAppearance = map[string]KindAppearance{
	...
	"NodePhiTheta": {Fill: "#e8f5e9", Stroke: "#2e7d32", Desc: "One half of a φ, θ pair: adds each angle's offset to that angle of its center, wrapping at that angle's quarter turn inclusive, and sends the stepped center on as the partner's next arrival."},
}
