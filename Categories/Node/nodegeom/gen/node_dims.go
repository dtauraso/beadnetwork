...
func writeNodeDims(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by Categories/Node/nodegeom/gen — do not edit.`)
...
func writeNodeKindID(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by Categories/Node/nodegeom/gen — do not edit.`)
	fmt.Fprintln(w, `// Source: Categories/NodeKinds/<Kind>/SPEC.md + bead.Register calls.`)
	fmt.Fprintln(w, `// Regenerate with: go generate ./...`)
	fmt.Fprintln(w)
	...
	fmt.Fprintln(w, `// assigned once per kind in Categories/NodeKinds/<Kind>/SPEC.md and never renumbered by sort`)
	...
	fmt.Fprintln(w, `// and assigned once (see Categories/NodeKinds/<Kind>/SPEC.md kindId), so — unlike the id`)
	...
	fmt.Fprintln(w, `// and the description, both authored in Categories/NodeKinds/<Kind>/SPEC.md alongside the id.`)
