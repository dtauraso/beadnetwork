...
# PLACEMENT: Categories/Node/node_state.go,Categories/Node/stream_sink.go | every NodeState field must be named by the adapter that fills it, or it writes a zero into the node file while everything compiles
