...
# PLACEMENT: Categories/Node/**/*.go | no sync.Mutex/RWMutex and no sync/atomic in the network: use ownership + message passing
...
roots = ["Categories/Node", "Categories/NodeKinds", "Categories/Ring/Bead"]
