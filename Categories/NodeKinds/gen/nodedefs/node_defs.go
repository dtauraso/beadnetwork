...
func WriteNodeDefs(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by Categories/NodeKinds/gen — do not edit. Source: Categories/NodeKinds/<Kind>/node.go + SPEC.md`)
	fmt.Fprintln(w)
	...
	fmt.Fprintln(w, ` * in Categories/Node/node_kind_id_gen.go. */`)
