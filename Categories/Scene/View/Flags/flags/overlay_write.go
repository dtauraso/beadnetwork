...
func writeOverlayPreamble(w *bufio.Writer, source string) {
	fmt.Fprintln(w, `// GENERATED by Categories/Scene/View/Flags/flags — do not edit.`)
	fmt.Fprintf(w, "// Source: %s\n", source)
	fmt.Fprintln(w, `// Regenerate with: go generate ./...`)
	fmt.Fprintln(w)
	fmt.Fprintln(w, `package Flags`)
	fmt.Fprintln(w)
}
...
func writeOverlayStateGen(outPath string, flags []overlayFlag) error {
	...
	writeOverlayPreamble(w, "the flag names in Categories/Scene/View/Flags/flags.ts.")
