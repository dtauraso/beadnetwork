...
func main() {
	genpaths.SetName("Categories/Scene/Wiring/kindports")
	repoRoot, srcRoot := genpaths.Roots()
	kinds := Kinds(repoRoot)

	outPath := filepath.Join(srcRoot, "Scene", "Wiring", "kind_ports_gen.go")
...
func writeKindPorts(outPath string, kinds []KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by Categories/Scene/Wiring/kindports — do not edit.`)
