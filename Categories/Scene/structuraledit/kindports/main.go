...
func main() {
	genpaths.SetName("Categories/Scene/structuraledit/kindports")
...
func writeKindPorts(outPath string, kinds []KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by Categories/Scene/structuraledit/kindports — do not edit.`)
	fmt.Fprintln(w, `// Source: Categories/NodeKinds/<Kind>/SPEC.md ## Ports table.`)
	fmt.Fprintln(w, `// Regenerate with: go generate ./...`)
	fmt.Fprintln(w)
	fmt.Fprintln(w, `package structuraledit`)
	fmt.Fprintln(w)
