...
func WriteWireDefs(outPath string, props []wireProp) error {
	...
	fmt.Fprintln(w, `// GENERATED by: go generate ./... (regenerate after editing wire:"..." tags in Categories/Scene/scenebuild/topo_spec.go)`)
	fmt.Fprintln(w, `// Source: Categories/Scene/scenebuild/topo_spec.go wire:"prop,..." tags. Do not edit by hand.`)
	fmt.Fprintln(w)
