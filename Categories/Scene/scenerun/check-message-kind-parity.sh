...
# PLACEMENT: Categories/Scene/Drag/stdin_reader.go,Start/extension/messages.ts,Start/extension/handle-message.ts,Start/extension/webview/** | a new message kind needs matching entries in Go's MSG_TYPES fence+doc, messages.ts, and a live sender
...
HANDLE_MESSAGE_TS="$REPO_ROOT/Start/extension/handle-message.ts"
WEBVIEW_SRC_DIR="$REPO_ROOT/Start/extension/webview"
