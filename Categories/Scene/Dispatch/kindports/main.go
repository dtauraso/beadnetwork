...
func main() {
	genpaths.SetName("Categories/Scene/Dispatch/kindports")
	repoRoot, srcRoot := genpaths.Roots()
	kinds := Kinds(repoRoot)

	outPath := filepath.Join(srcRoot, "Scene", "Dispatch", "kind_ports_gen.go")
