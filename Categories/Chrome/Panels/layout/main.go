...
func writePathFiles(pathsDir string) error {
	...
	if err := genpaths.WriteIfChanged(filepath.Join(pathsDir, "block.bin"), []byte(Panels.ValueRelPath), 0o644); err != nil {
		return err
	}
...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Categories/Chrome/Panels/values from PointerTargetValueNames in\n")
...
func main() {
	genpaths.SetName("Categories/Chrome/Panels/layout")
