...
func writePathFiles(pathsDir string) error {
	...
	if err := genpaths.WriteIfChanged(filepath.Join(pathsDir, "block.bin"), []byte(SliderPanel.ValueRelPath), 0o644); err != nil {
		return err
	}
...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Categories/Chrome/Panels/SliderPanel/values from PanelValueNames in\n")
...
func main() {
	genpaths.SetName("Categories/Chrome/Panels/SliderPanel/layout")
