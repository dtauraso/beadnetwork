...
func writePathFiles(pathsDir string) error {
	...
	if err := genpaths.WriteIfChanged(filepath.Join(pathsDir, "block.bin"), []byte(FitButton.ValueRelPath()), 0o644); err != nil {
		return err
	}
...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by Categories/Chrome/Pills/FitButton/values from ChipValueNames in\n")
...
func main() {
	genpaths.SetName("Categories/Chrome/Pills/FitButton/layout")
