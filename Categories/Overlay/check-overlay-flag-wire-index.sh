...
# PLACEMENT: Categories/Overlay/flags.ts,Categories/Chrome/Panels/Panel/flags.ts,Categories/Input/gen/input_layout_declared.go | the overlay/panel flag REGISTRY and the wire ordering in INPUT_LAYOUT_FINGERPRINT must list the same flags in the same order
...
REGISTRY = {
    "OVERLAY_FLAGS": "Categories/Overlay/flags.ts",
    "PANEL_FLAGS": "Categories/Chrome/Panels/Panel/flags.ts",
}
FINGERPRINT = "Categories/Input/gen/input_layout_declared.go"
