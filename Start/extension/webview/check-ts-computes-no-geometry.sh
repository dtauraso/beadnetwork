...
# PLACEMENT: Start/extension/webview/**/*.ts,Start/extension/webview/**/*.tsx | TS plots what Go streams: no bead positions, no edge curves, no traversal timing computed here
set -euo pipefail
...
SRC_DIR="$REPO_ROOT/Start/extension/webview"
