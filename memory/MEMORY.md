...
- [project_wire_is_straight_line_not_chain.md](project_wire_is_straight_line_not_chain.md) — Original bead-item chain's O(N²) lag was human-clock gating + momentum-free midpoint relaxation, not "a chain of beads"; corrected chain-bead-as-goroutine model (nodes/wire/bead_actor.go) fixes both causes
