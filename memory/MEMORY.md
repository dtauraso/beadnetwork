...
- [project_theta_phi_tilted_camera.md](project_theta_phi_tilted_camera.md) — Apparent θ mismatch is usually φ seen through a tilted camera; measure θ from world +y
