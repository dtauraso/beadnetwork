...
**Why:** Near-miss on 2026-05-03 — deleted `../package.json` while trying to remove a stray root one. Recovered via `git checkout HEAD --`, but the file could have been untracked.
