...
func writeNames(path string) error {
	...
	b.WriteString("// GENERATED by src/Chrome/Panels/TiltPanel/gen from PanelValueNames in\n")
	...
	b.WriteString("// learns where that block is from src/Chrome/Panels/TiltPanel/paths/, which Go\n")
