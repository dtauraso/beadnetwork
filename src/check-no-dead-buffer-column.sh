...
# PLACEMENT: src/**/buffer_block.go,src/Buffer/bufschema/layout*.go,src/Buffer/buffer-layout*.ts | every buffer column needs a non-test production consumer; delete an unused one rather than allowlisting it
