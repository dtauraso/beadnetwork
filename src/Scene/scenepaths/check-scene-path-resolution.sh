...
# PLACEMENT: src/Node/Wiring/**/*.go | view/*.json path resolution lives only in scene_paths.go; nodes/ path Join lives only in node_mover.go/new_node_files.go/edge_mover.go/loader_tree.go/tree_shape.go
