...
# PLACEMENT: src/**/*_values.go,src/Input/gen/input_layout_declared.go,src/NodeKinds/*/SPEC.md | changing a generator source means running `go generate ./...` in the SAME commit
set -euo pipefail
