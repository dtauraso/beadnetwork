...
# PLACEMENT: src/**/*_values.go,src/Input/Codec/input_fingerprint.go,src/NodeKinds/*/SPEC.md | changing a generator source means running `go generate ./...` in the SAME commit
set -euo pipefail
