...
func BuildEdgeSeed(label string, ep edge.EdgeEndpoints, geoms map[string]nodegeom.NodeGeom) (EdgeGeomSeed, error) {
...
func MutualPairs(edgeEndpoints map[string]edge.EdgeEndpoints) map[string]map[string]bool {
