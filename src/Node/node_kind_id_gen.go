...
// Source: src/Node/<Kind>/SPEC.md + bead.Register calls.
...
// assigned once per kind in src/Node/<Kind>/SPEC.md and never renumbered by sort
...
// and assigned once (see src/Node/<Kind>/SPEC.md kindId), so — unlike the id
...
// and the description, both authored in src/Node/<Kind>/SPEC.md alongside the id.
