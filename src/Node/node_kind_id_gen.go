...
// Source: src/NodeKinds/<Kind>/SPEC.md + bead.Register calls.
...
// and assigned once (see src/NodeKinds/<Kind>/SPEC.md kindId), so — unlike the id
...
// and the description, both authored in src/NodeKinds/<Kind>/SPEC.md alongside the id.
