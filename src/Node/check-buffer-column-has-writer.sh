...
# PLACEMENT: src/Node/buffer_block.go,src/Overlay/buffer_block.go,src/Chrome/Panels/Panel/buffer_block.go,src/runtopology/node_stream.go,src/runtopology/view_stream.go | a Node/Overlay/Panel column must be named by the runtopology adapter that fills its row, or it silently streams zeros
...
PAIRS = [
    ...
    ("src/Chrome/Panels/Panel/buffer_block.go",   "bufLayoutPanel",   "src/runtopology/view_stream.go"),
]
