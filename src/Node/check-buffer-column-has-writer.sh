...
# PLACEMENT: src/Node/buffer_block.go,src/Overlay/buffer_block.go,src/Panel/buffer_block.go,src/Node/runtopology/node_stream.go,src/Node/runtopology/view_stream.go | a Node/Overlay/Panel column must be named by the runtopology adapter that fills its row, or it silently streams zeros
...
PAIRS = [
    ...
    ("src/Panel/buffer_block.go",   "bufLayoutPanel",   "src/Node/runtopology/view_stream.go"),
]
