...
# PLACEMENT: src/Node/**/*.go | no sync.Mutex/RWMutex and no sync/atomic in the network: use ownership + message passing
...
roots = ["src/Node", "src/NodeKinds", "src/Ring/Bead", "src/schema/buffer-layout", "src/schema/buffer-layout"]
