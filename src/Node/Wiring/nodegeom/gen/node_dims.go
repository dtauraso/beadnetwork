...
func writeNodeDims(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// Source: src/Node/<Kind>/SPEC.md ## View width/height fields.`)
...
func writeNodeKindID(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by src/Node/Wiring/nodegeom/gen — do not edit.`)
	fmt.Fprintln(w, `// Source: src/Node/<Kind>/SPEC.md + bead.Register calls.`)
	fmt.Fprintln(w, `// Regenerate with: go generate ./...`)
	fmt.Fprintln(w)
	...
	fmt.Fprintln(w, `// assigned once per kind in src/Node/<Kind>/SPEC.md and never renumbered by sort`)
	...
	fmt.Fprintln(w, `// and assigned once (see src/Node/<Kind>/SPEC.md kindId), so — unlike the id`)
	...
	fmt.Fprintln(w, `// and the description, both authored in src/Node/<Kind>/SPEC.md alongside the id.`)
