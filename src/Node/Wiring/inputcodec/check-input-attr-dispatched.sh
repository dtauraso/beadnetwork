...
# PLACEMENT: src/Node/Wiring/inputcodec/edit_update_decode.go,src/Node/Wiring/inputcodec/edit_update_decode_scene.go,src/Node/Wiring/dispatch/dispatch_edit.go | a new addressed-edit attribute must reach a handler, not just decode off the wire
