...
# PLACEMENT: src/Node/Wiring/stdinreader/stdin_reader.go,src/messages.ts,src/extension/handle-message.ts,src/webview/** | a new message kind needs matching entries in Go's MSG_TYPES fence+doc, messages.ts, and a live sender
