...
func writeGoPaths(overlayDir string, flags []overlayFlag) error {
	...
	fmt.Fprintln(&buf, `// Source: the OVERLAY_FLAGS block in src/Input/Codec/messages.ts.`)
...
func writeDefaultsTS(overlayDir string, flags []overlayFlag) error {
	...
	fmt.Fprintln(&b, `// Source: the OVERLAY_FLAGS block in src/Input/Codec/messages.ts.`)
	fmt.Fprintln(&b, `//`)
