...
# PLACEMENT: src/NodeKinds/SPEC-FORMAT.md,src/NodeKinds/gen/kindscan/spec_md.go | the `## View` field table must name exactly the view.* fields parseSpecMD reads
set -euo pipefail
...
GEN_DIR="src/NodeKinds/gen/kindscan"
