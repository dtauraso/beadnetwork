...
import (
	...
	"github.com/dtauraso/wirefold/src/schema/buffer-layout/gen/constexpr"
)
...
func WriteShadingParams(outPath string, params []shadingParam) error {
	...
	fmt.Fprintln(w, `// Source: src/Node/Wiring/nodegeom/shading_params.go ShadingParam* constants.`)
