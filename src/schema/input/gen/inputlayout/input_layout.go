...
func WriteInputLayout(outPath string, fp *inputLayoutFingerprint) error {
	...
	fmt.Fprintln(w, `// GENERATED by src/schema/input/gen — do not edit.`)
	fmt.Fprintln(w, `// Source: src/Node/Wiring/inputcodec/input_fingerprint.go's InputLayoutFingerprint const.`)
