...
# PLACEMENT: NodeKinds/SPEC-FORMAT.md,NodeKinds/gen/kindscan/spec_md.go | the `## View` field table must name exactly the view.* fields parseSpecMD reads
set -euo pipefail
...
GEN_DIR="NodeKinds/gen/kindscan"
DOC="NodeKinds/SPEC-FORMAT.md"
