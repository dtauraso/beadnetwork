...
// runGate wires one SelectRight instance on a real clock, feeds
...
// TestSelectRightFiresLean covers SelectRight's core
...
func TestSelectRightFiresLean(t *testing.T) {
