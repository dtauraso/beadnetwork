...
//
// Same pattern nodes/Wiring/node_geometry_parts.go follows (and tools/network/structure/check-composer-fields.sh
...
//
// Same pattern node_geometry_parts.go follows (and tools/network/structure/check-composer-fields.sh guards
