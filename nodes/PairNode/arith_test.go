...
// arith_test.go — the closed-form arithmetic docs/pair-node/math/arith.html and the update-rules
// page rest on: one round written without a case in it, the walk as a closed form, and the
// resting lengths derived from the possible gaps.
//
