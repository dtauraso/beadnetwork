...
// run loop lives in edge_mover_run.go; its inbox message handler and the geometry
// recompute it drives (handle, recomputeGeometry) live in edge_mover_handle.go.
package edgemover
...
// handle, recomputeGeometry: see edge_mover_handle.go.
