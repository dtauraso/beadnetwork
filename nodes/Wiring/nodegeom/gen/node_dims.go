...
func writeNodeDims(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// GENERATED by nodes/Wiring/nodegeom/gen — do not edit.`)
...
func writeNodeKindID(outPath string, kinds []kindscan.KindEntry) error {
	...
	fmt.Fprintln(w, `// and the description, both authored in nodes/<Kind>/SPEC.md alongside the id.`)
