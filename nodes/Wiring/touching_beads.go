...
// dragTouchingBeads resolves nm's own incident-edge neighbours (via md.mr.edgeMovers,
...
func dragTouchingBeads(md *MoveDispatch, nm *nodeGeometry, prevPos vec3) []beadcrud.TouchingBead {
