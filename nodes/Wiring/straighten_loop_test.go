...
// The straightening loop's rule now lives on the NODE KIND's own goroutine (Node1,
// nodes/Node1/node_test.go — one goroutine, no mover involved,
...
// FROM the tilt (nodes/Node1/node.go's coplanarNormal, run unmodified by both nodes of a
